...
cp ${BUILD_DIR}/linux-${linux_version}/arch/arm/boot/dts/stm32f769-disco.dtb ${BINARIES_DIR}
cp ${BUILD_DIR}/linux-${linux_version}/arch/arm/boot/dts/stm32f769-disco.dtb ${dir_publish}
